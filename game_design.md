...
| **Anchor** (Ctrl) | held | grip terrain: incoming knockback ×0.2, ring-out/downhill slide ×0.1, tilt recovers 0.08 rad/s, **spin regen +150/s** — all four apply only once held past the 6-step startup. Startup 6, release 8. | move ×0.1 (rooted, from step 1), deals nothing, builds **no** meter, auto-breaks on *structural* slopes > ~22° (basin+wall only, decorative ridges don't count — the wall band, r ≈ 7.49, comfortably past the wall's r=7.0 start); opponent charges freely while you sit |
